...
const selectedProductPeriod = ref('day')
...
const loadDashboardData = async () => {
  try {
    ...
    // Test data để minh họa logic mới (xóa sau khi test)
...
const updateChartData = async () => {
  try {
    ...
    const finalLabels = paddedLabels.slice(0, 7)
